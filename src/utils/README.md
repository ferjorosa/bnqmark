...
- **`code_analysis_utils`** — Static AST metrics for generated code, including arithmetic operator counts and largest explicit multiplication chain.
...
- `analyze_response_arithmetic(response)` — Count explicit arithmetic operations in generated code responses.
